...
const FacultyDetailsPnpl = ({ route }) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TextInput
          ...
          <TextInput
            style={styles.input}
            value={updatedValues.experience}
            onChangeText={text => setUpdatedValues(prev => ({ ...prev, experience: text }))}
...
export default FacultyDetailsPnpl;
