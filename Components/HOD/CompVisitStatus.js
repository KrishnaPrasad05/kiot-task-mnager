...
const CompVisitStatus = () => {
    ...
    const handleResolvedTask = (point) => {
      ...
      navigation.navigate('ViewCompVisit', { point });
    };
    ...
    const handleReport = () => {
      // Navigate to the other page when the button is pressed
      navigation.navigate('ReportTableCV'); // Replace 'OtherPage' with the name of the target screen
    };
...
export default CompVisitStatus;