...
const AssignedPooled = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`https://${variableValue}/pooled?assignTo=${name}`);
  ...
  const handleItemPress = (item) => {
    navigation.navigate('AssignedPoolDetails', { faculty: item });
  };
