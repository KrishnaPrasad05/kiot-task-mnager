        ...
        <View style={styles.modalContainer}>
          ...
          <View style={{
            ...
            <TouchableOpacity style={{
              backgroundColor: 'rgba(2,76,18,1)', padding: 10, width: 100, borderRadius: 10, marginRight: 50
            }} onPress={handleUpdate}>
              <Text style={{ color: 'white', textAlign: 'center' }}>Save</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{
              backgroundColor: 'grey', padding: 10, width: 100, borderRadius: 10
